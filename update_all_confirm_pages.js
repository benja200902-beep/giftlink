...
const templateHTML = fs.readFileSync('./gift/template.html', 'utf8');
...
PRODUCTS.forEach(product => {
    ...
    productHTML = productHTML.replace(/\$10\.00/g, `$${product.price}`);
    
    // Replace the alt text
    productHTML = productHTML.replace(/alt="1,000 Gold"/g, `alt="${product.name}"`);
...
console.log('All confirm pages created with new template!');
